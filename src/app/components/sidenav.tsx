...
export default function Sidenav(props: sideNavProps) {
  return (
    <>
      ...
      <nav
        className={`block lg:hidden transition-all fixed left-0 top-0 h-full w-full overflow-hidden bg-black/80 backdrop-blur-xl border-r border-white/10 transform-gpu z-50 ${props.showSideNav ? "" : "-translate-x-full"
          }`}
      >

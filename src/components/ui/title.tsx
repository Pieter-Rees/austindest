      ...
      <div className={myFont.className}>
        {title && (
          <div className="relative">
            <h1
              className={`text-7xl sm:text-8xl lg:text-9xl text-shine text-neon-title ${center ? "text-center lg:text-left" : ""
                }`}
            >
              {title}
            </h1>
            <span
              className={`absolute top-0 text-7xl sm:text-8xl lg:text-9xl text-shine ${center ? "text-center lg:text-left left-0 right-0" : ""
                }`}
            >
              {title}
            </span>

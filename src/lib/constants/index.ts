export const SOCIAL_LINKS = {
  ...
  spotify: "https://open.spotify.com/artist/6929wCqfP5hZJAwC3KWE8s?go=1&sp_cid=b30d4cf76015532c872be09c115a6615&nd=1",
...
export const SPOTIFY_EMBEDS = {
  artist: "https://open.spotify.com/embed/artist/4i1SjBqGZ4lVlEgMfpKVjb?utm_source=generator&theme=0",
  track1: "https://open.spotify.com/embed/track/6aV4L76qLqOXKWM2KDI1IU?utm_source=generator",
  track2: "https://open.spotify.com/embed/track/21RfPY7y0nx5B0KuZm3k77?utm_source=generator"
} as const;

export const SOUNDCLOUD_EMBED = "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/1412583274&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true";

export const YOUTUBE_VIDEO = "https://youtu.be/3DWK8802N00?t=2546";

export const BACKGROUND_VIDEO = "https://youtu.be/oB325uTDKIw?si=FbP7X-cNp9hmUk2M";

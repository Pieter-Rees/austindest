...
describe('Listen', () => {
    it('renders section header with correct props', () => {
        ...
        expect(screen.getByTestId('props')).toHaveTextContent('right:true center:false');
    });
    ...
    it('renders SoundCloud embed', () => {
        ...
        expect(soundcloudIframe).toHaveAttribute('src', expect.stringContaining('soundcloud.com'));
    ...
    it('renders Spotify embeds', () => {
        ...
        expect(spotifyArtist).toHaveAttribute('src', expect.stringContaining('spotify.com'));
        expect(spotifyTrack1).toHaveAttribute('src', expect.stringContaining('spotify.com'));
        expect(spotifyTrack2).toHaveAttribute('src', expect.stringContaining('spotify.com'));
    });

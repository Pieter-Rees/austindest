...
jest.mock('react-player', () => ({
    __esModule: true,
    default: ({ width, height, src, playing, loop, playbackRate, muted, controls, className, style }: any) => (
        <div
...
describe('LandingBg', () => {
    it('renders video player with correct props', () => {
        ...
        expect(player).toHaveAttribute('data-src', 'https://example.com/background-video.mp4');

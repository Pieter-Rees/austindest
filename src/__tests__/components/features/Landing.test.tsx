...
describe('Landing', () => {
    it('renders title with correct props', () => {
        ...
        expect(screen.getByTestId('title-props')).toHaveTextContent('margin:true left:true center:true');
    });
    ...
    it('has correct container structure and classes', () => {
        ...
        expect(mainDiv).toHaveClass('w-full', 'h-full', 'my-6', 'lg:my-0', 'relative', 'z-2');

...
describe('Logo', () => {
    ...
    it('renders with proper styling', () => {
        ...
        expect(logoContainer).toHaveClass('relative', 'hover:animate-spin-slow', 'cursor-grab');
    });
    ...
    it('has proper neon styling for first A', () => {
        ...
        expect(firstA).toHaveClass('absolute', 'z-2', 'left-0', 'text-5xl', 'lg:text-5xl', 'text-neon-title');
    });
    ...
    it('has proper shine styling for second A', () => {
        ...
        expect(secondA).toHaveClass('relative', 'z-0', 'text-5xl', 'lg:text-5xl', 'text-shine');
    });

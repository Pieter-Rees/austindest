...
describe('Sidenav', () => {
    ...
    it('renders overlay when showSideNav is true', () => {
        ...
        expect(overlay).toHaveClass('fixed', 'inset-0', 'bg-black/30', 'backdrop-blur-sm', 'z-40', 'lg:hidden');
    });
    ...
    it('applies correct nav classes when showSideNav is true', () => {
        ...
        expect(nav).toHaveClass('block', 'lg:hidden', 'transition-all', 'fixed', 'left-0', 'top-0', 'h-full', 'w-full', 'overflow-hidden', 'bg-black/80', 'backdrop-blur-xl', 'border-r', 'border-white/10', 'transform-gpu', 'z-50');
    });
    ...
    it('has correct navigation structure', () => {
        ...
        expect(container).toHaveClass('flex', 'flex-col', 'justify-center', 'items-center', 'h-full');
    });
    ...
    it('has correct links container structure', () => {
        ...
        expect(linksContainer).toHaveClass('flex', 'flex-col', 'justify-center', 'items-center', 'uppercase', 'gap-8');
    });

    it('has correct socials container structure', () => {
        render(<Sidenav handleToggle={mockHandleToggle} showSideNav={true} />);

        const socialsContainer = screen.getByTestId('socials').closest('div')?.parentElement;
    ...
    it('renders without crashing', () => {
        expect(() => render(<Sidenav handleToggle={mockHandleToggle} showSideNav={true} />)).not.toThrow();
    });
});
